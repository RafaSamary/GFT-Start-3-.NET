...
namespace Coleções.Helper
{
    public class OperacoesArray
    {
        ...
        public void OrdenarBublleSort(ref int[] array) // algotitimo buble sort de orfdenação 
        {
            int temp = 0;
        ...
        public void CopiarArray(ref int[] array, ref int[] arrayDesino)
        {
              Array.Copy(array, arrayDesino, array.Length);
        }
